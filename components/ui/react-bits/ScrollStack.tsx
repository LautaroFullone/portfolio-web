...
const ScrollStack: React.FC<ScrollStackProps> = ({
   ...
   const updateCardTransforms = useCallback(() => {
      ...
      // Calculate the total physical height of the stacked group so we can release it flush with the end element without overlaps
      ...
      const pinEnd = endElementTop - groupHeight
   ...
   return (
      ...
      >
         <div
            className={`scroll-stack-inner ${useWindowScroll ? '' : 'pt-[20vh] px-20 pb-200 min-h-screen'}`}
