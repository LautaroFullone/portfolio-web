    ...
    <section id="experience" className="px-6 py-28 lg:py-36">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 relative">
          {/* Timeline line */}
          <div className="absolute left-0 top-0 bottom-0 w-px bg-border md:left-[140px]" aria-hidden="true" />

          <div className="flex flex-col gap-12">
            {items.map((exp) => (
              <div key={exp.role} className="relative flex flex-col gap-4 pl-8 md:flex-row md:gap-12 md:pl-0">
                {/* Period */}
                ...
                {/* Dot */}
                <div className="absolute left-0 top-1.5 md:left-[140px] md:-translate-x-1/2" aria-hidden="true">
