...
export function Technologies() {
  ...
  return (
    <section id="technologies" className="bg-muted px-6 py-28 lg:py-36">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6">
          {technologies.map((tech) => (
            <div
              key={tech.name}
              className="group flex flex-col items-center gap-3 border border-border bg-card p-6 transition-all duration-300 hover:border-primary/50 hover:bg-secondary"
            >
